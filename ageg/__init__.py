...
from .admin import generer_sousquestion_admin, generer_options_admin
from .executif import generer_questions_exec

from models.answer import Answer
from models.group import Group
from models.question import Question

def generer_questionnaire(configuration):
    if os.path.isfile(configuration.fichiers.admin_saisonniers) and os.path.isfile(configuration.fichiers.executif):
